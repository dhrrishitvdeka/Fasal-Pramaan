...
void main() {
  group('LoginScreen Widget Tests', () {
    testWidgets('renders login form, fields, and submit buttons',
      ...
      expect(find.widgetWithText(ElevatedButton, 'Sign In / प्रवेश करें'),
          findsOneWidget);
      expect(find.widgetWithText(TextButton, 'Create Account'), findsOneWidget);
    });

    testWidgets('allows typing into email and password fields',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        const ProviderScope(
          child: MaterialApp(
