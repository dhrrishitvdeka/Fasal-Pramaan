...
final evidenceReminderSyncProvider =
    FutureProvider.autoDispose<void>((ref) async {
  try {
    await Future<void>.delayed(Duration.zero);
    evidenceNotificationService.flushPendingRoute();
    final api = ApiClient();
    // Skip network calls when the browser still holds a dead JWT.
    if (await api.ensureSession() == null) return;
    final plans = await api.evidenceReminders();
    await evidenceNotificationService.syncPlans(plans);
  } catch (_) {
    // The home screen and offline capture stay available while disconnected.
  }
});
...
class FarmerHomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ref.watch(evidenceReminderSyncProvider);
    final s = S.of(ref);
    final isHi = s.isHi;
        ...
        child: ListView(
          ...
          children: [
                        ...
                        children: [
                          ...
                          Text(
                            isHi
                                ...
                                : '5-step guided GPS photo verification',
                            style: const TextStyle(
                              fontSize: 13,
            ...
            _buildListTile(
              ...
              subtitle: 'Monthly 4–5 photo records for every crop cycle',
