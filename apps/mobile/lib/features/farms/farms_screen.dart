  ...
  Future<void> _createFarmDialog() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(isHi
              ? 'खेत निर्मित: ${farm['name']}'
              : 'Farm created: ${farm['name']}'),
  ...
  Future<void> _createPlotDialog(String farmId) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(isHi
              ? 'प्लॉट निर्मित: ${plot['name']}'
              : 'Plot created: ${plot['name']}'),
          backgroundColor: const Color(0xFF059669),
        ),
      );
              ...
              child: FadeSlideTransition(
                child: ListView(
                  ...
                  children: [
                              ...
                              children: [
                                ...
                                OutlinedButton.icon(
                                  ...
                                  icon: const Icon(
                                      ...
                                      size: 16),
                                  label: Text(s.addPlot,
                                      style: const TextStyle(fontSize: 12)),
                                  onPressed: () =>
                                      _createPlotDialog(f['id'].toString()),
                                ),
                              ],
                            ),
                          ),
                    ...
                    if (cycles.isEmpty)
                      _buildEmptyCard(isHi
                          ? 'कोई सक्रिय फसल चक्र नहीं मिला।'
                          : 'No active crop cycles found.')
                    else
                      ...cycles.map(
                        (c) => Padding(
                          padding: const EdgeInsets.only(bottom: 12),
