            ...
            child: Column(
              ...
              children: [
                ...
                _buildBilingualFeatureRow(
                  ...
                  descEn:
                      'GPS-verified crop photos with automatic blur checks.',
                ...
                _buildBilingualFeatureRow(
                  ...
                  descEn:
                      'Capture photos anywhere offline; sync securely online.',
                  descHi:
                      'बिना इंटरनेट फोटो खींचें, ऑनलाइन होने पर सुरक्षित सिंक करें।',
                ),
                const SizedBox(height: 10),
                _buildBilingualFeatureRow(
                  ...
                  descEn:
                      'Assistive AI combined with human reviewer validation.',
