...
class HelpScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text(isHi
              ? 'सहायता और कैप्चर ट्यूटोरियल'
              : 'Help & Capture Tutorial')),
      body: ListView(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style:
                      const TextStyle(fontSize: 13, color: Color(0xFFA7F3D0)),
                ),
              ],
            ),
          ),
          ...
          Text(
            isHi
                ? 'आवश्यक कोण चेकलिस्ट (Required Angles)'
          ...
          _buildAngleCard(
            ...
            descEn:
                'Stand at the plot boundary edge. Capture a broad panoramic view showing the overall crop field.',
            descHi:
                'खेत के किनारे खड़े होकर पूरी फसल क्षेत्र का व्यापक दृश्य लें।',
          ...
          _buildAngleCard(
            ...
            descEn:
                'Step closer into the plot. Capture the crop canopy so leaves, stems, and plant stand are clearly visible.',
          ...
          _buildAngleCard(
            ...
            descEn:
                'Move close to affected or damaged plants. Fill the camera frame with leaf disease or pest damage details.',
            descHi:
