...
class S {
  ...
  String get passwordLabel =>
      isHi ? 'पासवर्ड (न्यूनतम 8 अक्षर)' : 'Password (min 8 chars)';
  String get fullNameLabel => isHi ? 'पूरा नाम' : 'Full Name';
  String get phoneLabel =>
      isHi ? 'फोन नंबर (वैकल्पिक)' : 'Phone Number (Optional)';
  ...
  String get demoCredentialsNotice =>
      isHi ? 'डेमो क्रेडेंशियल लोड किए गए' : 'Demo Credentials Loaded';
  ...
  String get areaHectaresLabel =>
      isHi ? 'कुल क्षेत्रफल (हेक्टेयर)' : 'Total Area (Hectares)';
  String get addPlot => isHi ? 'प्लॉट जोड़ें' : 'Add Plot';
  String get addPlotBoundary =>
      isHi ? 'प्लॉट सीमा जोड़ें' : 'Add Plot Boundary';
  String get plotNameLabel => isHi ? 'प्लॉट का नाम' : 'Plot Name';
  String get centroidLatLabel =>
      isHi ? 'अक्षांश (Latitude)' : 'Centroid Latitude';
  String get centroidLonLabel =>
      isHi ? 'देशांतर (Longitude)' : 'Centroid Longitude';
  ...
  String get activeCropCycles =>
      isHi ? 'सक्रिय फसल चक्र' : 'Active Crop Cycles';
  ...
  String get allEvidenceSynced =>
      isHi ? 'सभी साक्ष्य सिंक हो चुके हैं' : 'All Evidence Synced';
  ...
  String get noSubmissions =>
      isHi ? 'कोई मूल्यांकन प्रस्तुतियाँ नहीं' : 'No Assessment Submissions';

  // Settings & Profile
  String get appPreferences => isHi ? 'ऐप प्राथमिकताएं' : 'App Preferences';
  String get hindiLanguage => isHi ? 'हिन्दी भाषा' : 'Hindi Language';
  String get targetApiBase =>
      isHi ? 'लक्ष्य API बेस URL' : 'Target API Base URL';
  String get systemSecurity =>
      isHi ? 'सुरक्षा और एन्क्रिप्शन' : 'App Security & Encryption';
