...
class AppConfig {
  ...
  /// A repeatable five-frame evidence sweep. Side-context frames make the
  /// record useful both before and after a localized weather event.
  static const requiredAngles = [
    'wide_field',
    'left_context',
    'mid_canopy',
    'right_context',
  ...
  static const voiceAssistantEnabled = bool.fromEnvironment(
