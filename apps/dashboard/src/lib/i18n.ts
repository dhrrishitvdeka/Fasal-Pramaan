...
const dict = {
  en: {
    ...
    farmerSub: "File claims, view 3-photo evidence guidelines, track AI verification, and resolve targeted recaptures.",
    ...
    captureStep1: "1. Field & Crop Overview",
    captureStep2: "2. Crop Condition",
    captureStep3: "3. Damage Detail",
    captureStep4: "4. Additional Perspective (Optional)",
    captureStep5: "5. Close-up Macro (Optional)",
    uploadSimulate: "Simulate 3-Photo Capture",
  ...
  hi: {
    ...
    farmerSub: "दावा दर्ज करें, 3-फ़ोटो साक्ष्य गाइड देखें, AI सत्यापन ट्रैक करें और पुनः कैप्चर कार्य पूरा करें।",
    ...
    captureStep1: "1. खेत व फसल का समग्र दृश्य",
    captureStep2: "2. फसल की स्थिति",
    captureStep3: "3. क्षति का विस्तृत विवरण",
    captureStep4: "4. अतिरिक्त परिप्रेक्ष्य (वैकल्पिक)",
    captureStep5: "5. क्लोज़-अप सूक्ष्म विवरण (वैकल्पिक)",
    uploadSimulate: "3-फ़ोटो कैप्चर सिमुलेशन",
