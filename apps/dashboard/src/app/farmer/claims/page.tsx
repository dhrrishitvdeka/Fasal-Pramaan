    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="relative w-full md:max-w-md">
          ...
          <input
            ...
            className="fp-input mt-0 min-h-11 w-full pl-9 text-sm sm:text-xs"
          />
        </div>
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border border-dashed border-slate-300 bg-white p-8 text-center sm:p-12">
          ...
          <h2 className="text-sm font-bold text-slate-700">{t.noClaimsFound}</h2>
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-auto">
                      {isRecapture ? (
                        <Link
                          ...
                          className="fp-btn-primary min-h-11 flex-1 gap-1.5 px-4 py-2 text-xs sm:flex-initial"
                        >
