...
_reminders_q = settings.celery_queue_reminders
...
celery_app.conf.update(
    ...
    task_routes={
        ...
        "generate_evidence_reminders": {"queue": _reminders_q},
    },
    beat_schedule={
        "evidence-reminders-every-six-hours": {
            "task": "generate_evidence_reminders",
