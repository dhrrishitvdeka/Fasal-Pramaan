...
def request_upload_urls(
    ...
    db.flush()
    required = set(recapture.required_angles or []) if recapture else DEFAULT_EVIDENCE_ANGLES
...
def finalize_submission(
    ...
    if not retrying_finalized:
        ...
        from app.services.evidence_reminders import advance_plan_for_submission

        advance_plan_for_submission(db, sub)
