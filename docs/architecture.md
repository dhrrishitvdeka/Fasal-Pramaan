...
- **Key Subsystems**:
  ...
  - **Strict 75%+ Crop Quality Shutter Lock**: Prevents shutter actuation unless the live frame achieves $\ge 75\%$ crop match (or $\ge 40\%$ under fire burn perils), eliminating false captures and non-field images before upload.
