...
- **Technology**: Next.js 16 App Router, React 19, TypeScript, Tailwind CSS, TanStack Query. The single webapp covers the full farmer flow — there is no separate mobile client.
- **Key Subsystems**:
...
- **Technology**: Next.js 16 App Router, React 19, TypeScript, Tailwind CSS, TanStack Query, Lucide Icons, Leaflet GIS.
- **Key Subsystems**:
